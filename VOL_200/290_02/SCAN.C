...
/*
**	file:		scan.l
**	purpose:	Scanner for flex input
**	mods:		1989.12.30 - Roberto Artigas Jr
**			Updated this file to match the 'scan.c'
**			more closely. It seems that the same
**			indivitual that had NOT run the 'parse.y'
**			file through BISON/YACC for a while, had
**			ALSO not run 'scan.l' through FLEX/LEX.
*/
/*
