...
char **argv;                                        /* arg vector */
{
           ...
           if (argc < 3)               /* check for two filenames */
              ...
              if ((fptr1 = fopen(argv[1],"r")) == NULL) {
                  p = (struct tnode *)malloc(24); /* create first node */
                  pr = NULL;
...
FILE *fptr;
{
          ...
          for (i = 0; i < ptr->indent; i++)
               fprintf(fptr,"  ");  /* indent line */

          if (d == NEWINSTR) {
             fprintf(fptr,"%s",new[ptr->instr].defname);
             endline(ptr,fptr);
             return;
          }
          ...
          case 0:
             ...
             break;
          case 1:
             fprintf(fptr,"turnleft");
             endline(ptr,fptr);
             break;
          case 2:
             fprintf(fptr,"pickbeeper");
             endline(ptr,fptr);
             break;
          case 3:
             fprintf(fptr,"putbeeper");
             endline(ptr,fptr);
             break;
          case 4:
             fprintf(fptr,"turnoff");
             endline(ptr,fptr);
             break;
          case 8:
             fprintf(fptr,"END");
          ...
          case 5:
             ...
             break;
          case 6:
             fprintf(fptr,"BEGINNING-OF-PROGRAM\n");
             break;
          case 7:
             fprintf(fptr,"\n  BEGINNING-OF-EXECUTION\n");
             break;
          case 9:
             fprintf(fptr,"END-OF-EXECUTION\n");
...
endline(ptr,fptr)             /* add ; if required and start newline */
struct tnode *ptr;
FILE *fptr;
{
          int i;
...
printest(ptr,fptr)     /* print test after IF or WHILE */
struct tnode *ptr;
FILE *fptr; 
{
          ...
          switch(ptr->instr) {
          case 0:
             fprintf(fptr,"facing-north");
             break;
          case 1:
             fprintf(fptr,"not-facing-north");
             break;
          case 2:
             fprintf(fptr,"facing-south");
             break;
          case 3:
             fprintf(fptr,"not-facing-south");
             break;
          case 4:
             fprintf(fptr,"facing-east");
             break;
          case 5:
             fprintf(fptr,"not-facing-east");
             break;
          case 6:
             fprintf(fptr,"facing-west");
             break; 
          case 7:
             fprintf(fptr,"not-facing-west");
             break;        
          case 8:
             fprintf(fptr,"next-to-a-beeper");
             break;
          case 9:
             fprintf(fptr,"not-next-to-a-beeper");
             break;
          case 10:
             fprintf(fptr,"any-beepers-in-beeper-bag");
             break;
          case 11:
             fprintf(fptr,"no-beepers-in-beeper-bag");
             break;
          case 12:
             fprintf(fptr,"front-is-clear");
             break;
          case 13:
             fprintf(fptr,"front-is-blocked");
             break;
          case 14:
             fprintf(fptr,"left-is-clear");
             break;
          case 15:
             fprintf(fptr,"left-is-blocked");
             break;
          case 16:
             fprintf(fptr,"right-is-clear");
             break;
          case 17:
             fprintf(fptr,"right-is-blocked");
             break;
          case 18:
             menu();
             break;
