...
/* 23 May 1987 - adapted for (3,3) [HVM] */
...
# define DS	    15  /* number of distinct sums */
# define NX         10	/* number of sample rules */

char xrule[] =

	"000011201210000"  /* holdover 		*/
	"000101220120021"  /* class iv		*/
	"010000212211100"  /* blue dots		*/
	"010020002111002"  /* two worlds	*/
	"020000212211100"  /* red dots		*/

	"020101220001001"  /* class iv-ish	*/
	"102111211202020"  /* reds on blue	*/
	"110120002222112"  /* strange blotches	*/
	"210201000201020"  /* dots on bars	*/
	"211220020020222"  /* two bgnds		*/	
