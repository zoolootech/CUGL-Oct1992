 ...
 * 13-Dec-88 RA         Added an additional parameter to domsg to avoid
 *                      the 'integer casted to far pointer message' in
 *                      MS C 5.1 with the -AL flag (Roberto Artigas Jr).
 */
 ...
 */
{
        ...
        if (*severity == 'S')
            ...
            fprintf(stderr, format, (int) arg2);
        putc('\n', stderr);
        if ((file = infile) == NULL)
 ...
 */
{
        domsg("SError", format, sarg, (int)0);
        errors++;
}
 ...
 */
{
        domsg("IError", format, (char *)NULL, narg);
        errors++;
}
 ...
 */
{
        domsg("SFatal error", format, sarg, (int)0);
        exit(IO_ERROR);
}
 ...
 */
{
        domsg("SWarning", format, sarg, (int)0);
}
 ...
 */
{
        domsg("IWarning", format, (char *)NULL, narg);
}
