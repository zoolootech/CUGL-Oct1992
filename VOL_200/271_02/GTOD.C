...
/* use the following line if you have the "fixed" monthis() function */
/*      mstr = monthis(ptm->tm_mon);  */
/* use the following line if you have the "bad" monthis() function */
      mstr = monthis(ptm->tm_mon+1);
   ...
   ptm->tm_mon++;    /* insure it is in range 1-12 */
