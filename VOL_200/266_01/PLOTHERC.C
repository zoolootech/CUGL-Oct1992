/* MicroPLOX plot routine
   ...
   A device driver for Hercules graphics.
...
#include <graph.h>
#include "PLOX.H"
#define DX(A)  (A*4)/3  /* adjust x coordinate to fill screen */
#define DY(B) (B*32)/33 /* adjust y coordinate to fill screen */
#define YMAXDY   DY(YMAX)
#define TVON     _setvideomode(_HERCMONO);
...
#define NORMAL 1
#define NEWHUE(A)    /* no color for Hercules */
#include "monitor.c"
