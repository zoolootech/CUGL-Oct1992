...
DATE:           4-1-84;
DESCRIPTION:    String to math functions;
KEYWORDS:       Mathematical functions;
FILENAME:       STRMATH.C;
WARNINGS:       For IBM PC without 8087 NDP, must be written using only 
                C functions (enhancement packages);
AUTHORS:        Robert E. Sawyer; 
COMPILER:       DeSmet C; 
REFERENCES:     US-DISK 1308 (SMATH.C), Knuth, Art of Computer Programming
                V.2, and C. E. Burton, DDJ, #89, 'RSA: A Public Key 
                Cryptosystem, Part 1'. 
ENDREF
*/
/*
