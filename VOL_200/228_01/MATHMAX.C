 ...
 *	   compiler.							     *
 *	   By Max R. Drsteler, 12405 Village Sq. Terrace, Rockville MD      *
 *									     *
 *****************************************************************************
 */
 ...
 * Author: Max R. Drsteler, 10/2/83
 */
 ...
 * Header: math.h
 * Author: Max R. Drsteler 9/15/83
 */
 ...
 * Author: Max R. Drsteler 9/26/83
 */
double floor(x)
double x;
{
 ...
 * Author: Max R. Drsteler, 9/20/83
 */
 double exp(xi)
 double xi;
 {
