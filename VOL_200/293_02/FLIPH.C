...
#include <stdio.h>
#include <ctype.h>
unsigned char inbuf[256],fnamein[30],fnameout[30];
main(argc,argv)
int argc;
char *argv[];
{int i,j,lines;
