/* HEADER: CUG120.08;
   TITLE: L2;
   DATE: 00/00/1980;
   DESCRIPTION: "An improved linker for .CRL format object files.
	The jump table at the beginning of each function is eliminated.";
   KEYWORDS: relocatable,linker;
   SYSTEM: CP/M;
   FILENAME: L2.C;
   CRC: D3E7;
   SEE-ALSO: CLINK;
