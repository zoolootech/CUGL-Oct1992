...
DESCRIPTION:	"Compares two files, and prints differences.
		May be used with all file types.";

KEYWORDS:	File, utility, compare;
SYSTEM:		CP/M-80;
FILENAME:	FILECOMP.C;
WARNINGS:	"If the two files are not the same length, FILECOMP
		will consider them different in every byte beyond
		the point where the extra bytes appear in one of
		the files";
SEE-ALSO:	CUG Utilities II diskette;
AUTHORS:	H. Moran, R. Hollinbeck, J. Smith;
COMPILERS:	BDS C;
*/
/*****************************************************************

	Version 1.0, 10/27/79:
		H. Moran
	Version 1.1, 2/13/80:
		slight mod. H Moran.
	Version 1.1, 10/2/81:
		upgrade to v1.44 BDS C.
		R. Hollinbeck
	Version 1.3, 10/27/85:
		changed printf format for third column
		from %8b to %2x (BDS C does not recognize %b).
		John M. Smith
