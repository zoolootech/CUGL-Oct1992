/*	B.C
	...
	an H8/H19(ANSI) in a 2-drive CP/M 1.42 or 1.43:
	   ...
	   1.	#define	EXIT_STRING	  "\n\033G\033<"
			... GS .. \033< enters ANSI mode, strangely. ...
...
/* #include <b:stdef.c>
#include <b:system.c> Included out by GS */
...
#define	SKEW		    8
#define	VERTICAL_LINE	    '\140'

#define	SETTRK		    10
#define	SETSEC		    11
#define	SETDMA		    12
#define	READ		    13
#define INTER_DISK	    25	/* GS */
#define SELECT_DISK	    14  /* GS */
#define RESET		    '\0' /* GS */
#define EOS		    '\0' /* GS */
...
char *argv[];
{
	...
	char drive,entries,extents,logged_drive,loop_index;
	char index;			/* GS */ 
	char number_of_records;
	char sector,used,wildcard;
	int comp();
