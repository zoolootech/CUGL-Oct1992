...
DESCRIPTION:  "Contains the source for library functions: printf,
              fprintf, sprintf, fmspr, fputs";
KEYWORDS:     printf, fpintf, sprintf, fmspr, fputs;
FILENAME:     prtlib.c;
WARNINGS:     "Functions differ from those defined in K&R in that they
              need a parameter count as the last argument in a
              calling routine.";
*/
 /*
