static	char	RCSid[] =
"$Header: /nw2/tony/src/stevie/src/RCS/version.c,v 3.71 89/08/31 10:05:04 tony Exp $";

/*
 * Contains the declaration of the global version number variable.
 *
 * $Log:	version.c,v $
 * Revision 3.71  89/08/31  10:05:04  tony
 * Added support for job control (when BSD is defined in env.h). Also fixed
 * a problem with terminals that use delays in their termcap definitions.
 * 
 * Revision 3.70  89/08/27  08:30:10  tony
 * Fixed a bug (reported on USENET) with null search strings and colon
 * commands.
 * 
...
char	*Version = "STEVIE - Version 3.71";
