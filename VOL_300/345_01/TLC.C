/* TLC.C - "The Last Cross-referencer" - C Main routine					*/
...
char		ref_chars[MAX_REF_CHARS+1] = " fd";
...
file_rec_type		file_rec=
	...
	/*	file_list		*/		NULL,
	/*	curr_file		*/		NULL,
	/*	parm_fname		*/		"TLCParm.Dat",
	/*	resw_fname		*/		"TLCResw.Dat"
	};
...
char	**argv;
	...
	printf("\nThe Last C Cross-referencer (TLC) version:%s\n",TLC_VERSION);
