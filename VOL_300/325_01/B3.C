...
static	float	x10[]= {-35.0f,-32.0f,-28.0f,-24.0f,-20.0f,-10.0f, -6.0f, -3.0f,\
			 -7.0f,-13.0f,-15.0f,-15.0f,-20.0f,-25.0f,-28.0f,-26.0f,\
			-32.0f,-38.0f,-41.0f,-38.0f,-50.0f,-54.0f,-54.0f,-52.0f,\
			-58.0f,-63.0f,-66.0f,-67.0f,-58.0f,-64.0f,-66.0f,-66.0f,\
			-58.0f,-54.0f,-50.0f,-48.0f,-46.0f,-43.0f,-39.0f,-35.0f,\
			-58.0f,-42.0f,-52.0f,-40.0f,-40.0f,-30.0f,-38.0f,-30.0f,\
			-30.0f,-23.0f,-26.0f,-16.0f,-15.0f, -9.0f,-16.0f, -3.0f,\
			  2.0f,  7.0f, 14.0f, 17.0f, 21.0f, 40.0f, 50.0f, 57.0f,\
			 66.0f, 70.0f, 74.0f, 70.0f, 68.0f, 67.0f, 66.0f, 64.0f,\
			 62.0f, 61.0f, 60.0f, 57.0f, 56.0f, 53.0f, 50.0f, 49.0f,\
			 47.0f, 46.0f, 43.0f, 41.0f, 40.0f, 39.0f, 36.0f, 32.0f,\
			 31.0f, 30.0f, 29.0f, 27.0f, 24.0f, 22.0f, 21.0f, 19.0f,\
			 16.0f, 14.0f,-17.0f,-19.0f,-16.0f, 14.0f,-17.0f,-19.0f,\
			-16.0f, 14.0f, 13.0f, 13.0f, 13.0f, 12.0f, 10.0f,  6.0f,\
			  2.0f, 40.0f, 22.0f, 22.0f, 22.0f, 21.0f, 30.0f, 31.0f,\
			 31.0f, 30.0f, 39.0f, 39.0f, 39.0f, 38.0f, 47.0f, 46.0f,\
			 56.0f, 53.0f, 62.0f, 61.0f, 61.0f, 60.0f, 68.0f, 67.0f};

static	float	y10[]= { 13.0f, 18.0f, 23.0f, 28.0f, 32.0f, 38.0f, 41.0f, 43.0f,\
			 46.0f, 50.0f, 50.0f, 48.0f, 51.0f, 53.0f, 53.0f, 48.0f,\
			 52.0f, 53.0f, 52.0f, 48.0f, 53.0f, 53.0f, 52.0f, 49.0f,\
			 51.0f, 53.0f, 52.0f, 51.0f, 44.0f, 46.0f, 45.0f, 44.0f,\
			 38.0f, 34.0f, 30.0f, 26.0f, 20.0f, 17.0f, 14.0f, 13.0f,\
			 44.0f, 32.0f, 49.0f, 42.0f, 42.0f, 33.0f, 48.0f, 43.0f,\
			 43.0f, 37.0f, 48.0f, 42.0f, 48.0f, 44.0f, -9.0f, -9.0f,\
			-11.0f,-15.0f,-19.0f,-20.0f,-20.0f,-16.0f,-11.0f, -6.0f,\
			  4.0f, 10.0f, 15.0f, 15.0f, 14.0f, 18.0f, 20.0f, 20.0f,\
			 14.0f, 20.0f, 23.0f, 25.0f, 18.0f, 27.0f, 29.0f, 28.0f,\
			 19.0f, 31.0f, 33.0f, 32.0f, 27.0f, 24.0f, 32.0f, 33.0f,\
			 28.0f, 20.0f, 25.0f, 28.0f, 28.0f, 13.0f, 18.0f, 21.0f,\
			 21.0f, 10.0f, -3.0f, -7.0f, -9.0f, 10.0f, -3.0f, -7.0f,\
			 -9.0f, 10.0f,	0.0f,-10.0f,-13.0f,-14.0f,-14.0f,-14.0f,\
			-11.0f,  0.0f, 13.0f,  0.0f,  0.0f, -9.0f, 20.0f, 10.0f,\
			 10.0f,  0.0f, 24.0f, 10.0f, 10.0f, -3.0f, 19.0f,  6.0f,\
			 18.0f,  0.0f, 14.0f,  9.0f,  9.0f,  4.0f, 14.0f,  8.0f};
...
*/
    ...
    for (i=0;i<7;i++)
	PolyLine(2,&x10[40+i*2],&y10[40+i*2]);

    FllClr = 9;
    PxlClr  = 7;
    FillPoly(47,&x10[54],&y10[54]);
    PolyLine(47,&x10[54],&y10[54]);

    PxlClr  = 9;
    PolyLine(4,&x10[101],&y10[101]);

    FllClr = 1;
    PxlClr  = 7;
    PolyLine(8,&x10[105],&y10[105]);
    FillArea(WtoDX(x10[113]),WtoDY(y10[113]),PxlClr);

    for (i=0;i<10;i++)
	PolyLine(2,&x10[114+i*2],&y10[114+i*2]);
